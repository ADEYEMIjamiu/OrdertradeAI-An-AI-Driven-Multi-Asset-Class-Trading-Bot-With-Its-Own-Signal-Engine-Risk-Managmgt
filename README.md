...
An AI-driven, multi-asset-class trading bot with its own signal engine, risk management, tiered trade grading, and a live dashboard I built as an independent project to learn how real trading systems are designed end-to-end, from signal generation through execution, risk control, and monitoring.
