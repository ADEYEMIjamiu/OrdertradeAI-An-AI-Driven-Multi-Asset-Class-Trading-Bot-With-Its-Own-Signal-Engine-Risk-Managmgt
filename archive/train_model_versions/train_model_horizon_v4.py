...
# ============================================================
# MODEL EDGE DEVELOPMENT V4
# FIVE-DAY PREDICTION HORIZON EXPERIMENT
# ============================================================
...
CANDIDATE_MODEL_PATH = (
    RESEARCH_DIR
    / "trading_model_horizon_v4.pkl"
)

CANDIDATE_FEATURES_PATH = (
    RESEARCH_DIR
    / "features_horizon_v4.pkl"
)
...
def create_three_state_target(
    ...
    """
    Create a three-state target using the cumulative return
...
print()
print("=" * 72)
print("MODEL EDGE DEVELOPMENT V4")
print("FIVE-DAY PREDICTION HORIZON EXPERIMENT")
print("=" * 72)
print()
...
print(
    "[3/10] Creating five-day three-state "
    "trading target..."
)
...
print("=" * 72)
print("FIVE-DAY HORIZON V4 HOLDOUT RESULTS")
print("=" * 72)
...
print("[9/10] Running V4 research candidate gate...")
...
if all_gates_passed:
    ...
    print("=" * 72)
    print(
        "FEATURE V4 RESEARCH CANDIDATE RESULT: APPROVED"
    )
    print(
        "The candidate passed all V4 research gates."
    )
    print(
    ...
    print("=" * 72)
    print(
        "FIVE-DAY V4 RESEARCH CANDIDATE RESULT: REJECTED"
    )
    print(
        "The candidate did not pass all V4 research gates."
    )
    print(
        "No five-day V4 candidate model was saved."
    )
    print()
